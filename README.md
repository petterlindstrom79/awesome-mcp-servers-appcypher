...
- [Strale](https://github.com/strale-io/strale) - Trust layer for AI agents with 233+ verified data capabilities, real-time quality scores (SQS), audit trails, and EU AI Act compliance. Agents search, inspect trust profiles, and execute workflows via MCP. Free tier available.
